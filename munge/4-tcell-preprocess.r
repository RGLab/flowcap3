...
# Removed CIMR because of the following error:
# The individual flowFrames do not contain identical stains.
# Likely, we will have to write a separate munging script to update the stains.
...
write.csv(trans_widths, file = "data/tcell-transformations.csv", row.names = FALSE)
