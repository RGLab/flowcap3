...
mse<-melt(mse[,list(Manual=crossprod(.SD[Method%in%"Manual",fix]-.SD[Method%in%"Manual",fixr])[1]/nrow(.SD[Method%in%"Manual"]),OpenCyto=crossprod(.SD[Method%in%"Manual",fix]-.SD[Method%in%"OpenCyto",fix])[1]/nrow(.SD[Method%in%"Manual"]),flowDensity=crossprod(.SD[Method%in%"Manual",fix]-.SD[Method%in%"flowDensity",fix])[1]/nrow(.SD[Method%in%"Manual"])),list(Population)],id=c("Population"))
...
mse<-melt(mse[,list(Manual=crossprod(.SD[Method%in%"Manual",fix]-.SD[Method%in%"Manual",fixr])[1]/nrow(.SD[Method%in%"Manual"]),OpenCyto=crossprod(.SD[Method%in%"Manual",fix]-.SD[Method%in%"OpenCyto",fix])[1]/nrow(.SD[Method%in%"Manual"])),list(Population)],id=c("Population"))
